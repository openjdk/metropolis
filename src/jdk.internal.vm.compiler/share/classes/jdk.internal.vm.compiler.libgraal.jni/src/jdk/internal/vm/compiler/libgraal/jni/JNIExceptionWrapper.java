...
package jdk.internal.vm.compiler.libgraal.jni;

import static jdk.internal.vm.compiler.libgraal.jni.annotation.JNIFromLibGraal.Id.CreateException;
import static jdk.internal.vm.compiler.libgraal.jni.annotation.JNIFromLibGraal.Id.GetClassName;
import static jdk.internal.vm.compiler.libgraal.jni.annotation.JNIFromLibGraal.Id.GetStackTrace;
import static jdk.internal.vm.compiler.libgraal.jni.annotation.JNIFromLibGraal.Id.GetStackTraceElementClassName;
import static jdk.internal.vm.compiler.libgraal.jni.annotation.JNIFromLibGraal.Id.GetStackTraceElementFileName;
import static jdk.internal.vm.compiler.libgraal.jni.annotation.JNIFromLibGraal.Id.GetStackTraceElementLineNumber;
import static jdk.internal.vm.compiler.libgraal.jni.annotation.JNIFromLibGraal.Id.GetStackTraceElementMethodName;
import static jdk.internal.vm.compiler.libgraal.jni.annotation.JNIFromLibGraal.Id.GetThrowableMessage;
import static jdk.internal.vm.compiler.libgraal.jni.annotation.JNIFromLibGraal.Id.UpdateStackTrace;
import static jdk.internal.vm.compiler.libgraal.jni.JNIExceptionWrapperGen.callCreateException;
import static jdk.internal.vm.compiler.libgraal.jni.JNIExceptionWrapperGen.callGetClassName;
import static jdk.internal.vm.compiler.libgraal.jni.JNIExceptionWrapperGen.callGetStackTrace;
import static jdk.internal.vm.compiler.libgraal.jni.JNIExceptionWrapperGen.callGetStackTraceElementClassName;
import static jdk.internal.vm.compiler.libgraal.jni.JNIExceptionWrapperGen.callGetStackTraceElementFileName;
import static jdk.internal.vm.compiler.libgraal.jni.JNIExceptionWrapperGen.callGetStackTraceElementLineNumber;
import static jdk.internal.vm.compiler.libgraal.jni.JNIExceptionWrapperGen.callGetStackTraceElementMethodName;
import static jdk.internal.vm.compiler.libgraal.jni.JNIExceptionWrapperGen.callGetThrowableMessage;
import static jdk.internal.vm.compiler.libgraal.jni.JNIExceptionWrapperGen.callUpdateStackTrace;
import static jdk.internal.vm.compiler.libgraal.jni.FromLibGraalCalls.isHotSpotCall;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.ExceptionCheck;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.ExceptionClear;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.ExceptionDescribe;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.ExceptionOccurred;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.GetArrayLength;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.GetObjectArrayElement;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.GetObjectClass;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.NewObjectArray;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.SetObjectArrayElement;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.Throw;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.createHSString;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.createString;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.getBinaryName;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.findClass;

import org.graalvm.compiler.debug.TTY;
import jdk.internal.vm.compiler.libgraal.jni.JNI.JClass;
import jdk.internal.vm.compiler.libgraal.jni.JNI.JNIEnv;
import jdk.internal.vm.compiler.libgraal.jni.JNI.JObject;
import jdk.internal.vm.compiler.libgraal.jni.JNI.JObjectArray;
import jdk.internal.vm.compiler.libgraal.jni.JNI.JString;
import jdk.internal.vm.compiler.libgraal.jni.JNI.JThrowable;
import jdk.internal.vm.compiler.libgraal.jni.annotation.FromLibGraalEntryPointsResolver;
...
public final class JNIExceptionWrapper extends RuntimeException {
    ...
    private static final String HS_ENTRYPOINTS_CLASS = "jdk.internal.vm.compiler.libgraal.jni.JNIFromLibGraalEntryPoints";
     ...
     * {@link #wrapAndThrowPendingJNIException(jdk.internal.vm.compiler.libgraal.jni.JNI.JNIEnv, java.lang.Class...)}
     * in {@code stackTrace}.
     *

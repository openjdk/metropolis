...
import static jdk.internal.vm.compiler.libgraal.jni.JNIExceptionWrapper.wrapAndThrowPendingJNIException;

import jdk.internal.vm.compiler.libgraal.jni.annotation.FromLibGraalId;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.GetStaticMethodID;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.NewGlobalRef;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.getBinaryName;
import static jdk.internal.vm.compiler.libgraal.jni.JNIUtil.trace;
...
import jdk.internal.vm.compiler.libgraal.jni.JNI.JMethodID;
import jdk.internal.vm.compiler.libgraal.jni.JNI.JNIEnv;
import jdk.internal.vm.compiler.libgraal.jni.JNI.JObject;
import jdk.internal.vm.compiler.libgraal.jni.JNI.JValue;
...
public abstract class FromLibGraalCalls<T extends Enum<T> & FromLibGraalId> {
     ...
     * called from
     * {@link JNIExceptionWrapper#wrapAndThrowPendingJNIException(jdk.internal.vm.compiler.libgraal.jni.JNI.JNIEnv, java.lang.Class...)}.
     */
    ...
    /**
     * Describes a method in {@link #peer(jdk.internal.vm.compiler.libgraal.jni.JNI.JNIEnv) HotSpot peer class}.
     */

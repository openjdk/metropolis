...
public final class StackValue {
     ...
     * {@codesnippet jdk.internal.vm.compiler.nativeimage.StackValueSnippets#withSizeOf}
     *
     ...
     * {@codesnippet jdk.internal.vm.compiler.nativeimage.StackValueSnippets#ninePlusSixteenSqrt}
     *
     ...
     * {@codesnippet jdk.internal.vm.compiler.nativeimage.StackValueSnippets#withSizeOfArray}
     *
     ...
     *
     * {@codesnippet jdk.internal.vm.compiler.nativeimage.StackValueSnippets.callIntIntDouble}
     *
     * @param <T> the type, annotated by {@link CStruct} annotation
...
final class StackValueSnippets {
    // BEGIN: jdk.internal.vm.compiler.nativeimage.StackValueSnippets.ComplexValue
    @CStruct
    ...
    // END: jdk.internal.vm.compiler.nativeimage.StackValueSnippets.ComplexValue

    public static void ninePlusSixteenSqrt() {
        // BEGIN: jdk.internal.vm.compiler.nativeimage.StackValueSnippets#ninePlusSixteenSqrt
        ...
        // END: jdk.internal.vm.compiler.nativeimage.StackValueSnippets#ninePlusSixteenSqrt
    }
    ...
    private static void withSizeOf() {
        // BEGIN: jdk.internal.vm.compiler.nativeimage.StackValueSnippets#withSizeOf
        ComplexValue numberOnStack = StackValue.get(
                        SizeOf.get(ComplexValue.class));
        // END: jdk.internal.vm.compiler.nativeimage.StackValueSnippets#withSizeOf

    }

    // BEGIN: jdk.internal.vm.compiler.nativeimage.StackValueSnippets.IntOrDouble
    @CStruct("int_double")
    ...
    // END: jdk.internal.vm.compiler.nativeimage.StackValueSnippets.IntOrDouble

    // BEGIN: jdk.internal.vm.compiler.nativeimage.StackValueSnippets.acceptIntIntDouble
    ...
    // END: jdk.internal.vm.compiler.nativeimage.StackValueSnippets.acceptIntIntDouble

    private static double callIntIntDouble() {
        // BEGIN: jdk.internal.vm.compiler.nativeimage.StackValueSnippets.callIntIntDouble
        ...
        // END: jdk.internal.vm.compiler.nativeimage.StackValueSnippets.callIntIntDouble
        return sum;
    }

    @SuppressWarnings("StackValueGetClass")
    private static void withSizeOfArray() {
        // BEGIN: jdk.internal.vm.compiler.nativeimage.StackValueSnippets#withSizeOfArray
        IntOrDouble arrayOnStack = StackValue.get(
                        3, // number of array elements
                        SizeOf.get(IntOrDouble.class));
        // END: jdk.internal.vm.compiler.nativeimage.StackValueSnippets#withSizeOfArray
